...
<header class="topbar" role="navigation"
	...
	<div class="container clearfix">
		<h1>
			<a href="homePage.jsp" hardjump="" class="topbar-logo icon-logo"><span>饿了么</span></a>
		</h1>
			...
			<div topbar-profilebox="">
				<div class="topbar-profilebox">
					...
					<span class="topbar-profilebox-avatar icon-profile ng-hide"
						...
						ng-href="login.jsp" target="_top" href="login.jsp">登录/注册</a></span> <span
						class="topbar-profilebox-wrapper" ng-show="$root.user.username">
						<!-- ngIf: $root.topbarType === 'checkout' --> <span
						class="topbar-profilebox-username ng-binding">45931e099</span> <!-- ngIf: $root.topbarType === 'checkout' -->
						<!-- ngIf: $root.topbarType !== 'checkout' --> <span
